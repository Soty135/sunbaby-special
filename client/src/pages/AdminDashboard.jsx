    ...
    <div className="min-h-screen bg-gray-100">
      <div className="bg-red-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center py-3 md:py-6 gap-2 md:gap-0">
            <div className="flex flex-col">
              <h1 className="text-xl md:text-2xl font-bold">👨‍🍳 Admin Dashboard</h1>
              <span className="text-xs md:text-sm opacity-75">Welcome, {user?.email}</span>
            </div>
            <div className="flex space-x-2 md:space-x-4">
              <Link
                to="/"
                className="bg-white text-red-600 px-3 py-1.5 md:px-4 md:py-2 rounded-md text-sm font-medium hover:bg-gray-100"
              >
                View Site
              </Link>
              <button
                onClick={handleLogout}
                className="bg-red-700 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-md text-sm font-medium hover:bg-red-800"
              >
                Logout
              </button>
            </div>
